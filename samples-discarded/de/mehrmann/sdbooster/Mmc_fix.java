...
public class Mmc_fix implements Runnable {
	...
	private class MmcFileNameFilter implements FilenameFilter {
		...
		public boolean accept(File dir, String filename) {
			...
			switch (this.type) {
			case 0:
				if (filename.contains(Mmc_fix.BLK_NAME[0])) {
					return true;
				}
				break;

			case 1:
				if (filename.equals(Mmc_fix.BLK_NAME[1])) {
					return true;
				}
				break;
	...
	public Mmc_fix(Handler handler, int state) {
