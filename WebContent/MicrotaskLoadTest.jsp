...
<title>Microtask TEST Page</title>
...
<body onload="splitReplaceTestDescription()">
  ...
  function onloadTest(){
	...
	<br>
			...
			<form name="answerForm" method="get" action="microtask">
	...
	<br>
			<table cellspacing='0' cellpadding='0'  align="center"> 		
				...
				<tr>
					...
					<td align="right"><input TYPE="submit" name="answerButton" id="answerButton" VALUE="Submit"></td>
				</tr>
			</table>				
			<br>
			</form>	
