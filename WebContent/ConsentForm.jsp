  ...
  <script	src="jquery/quitDialog.js"></script>
	...
	var quitFormAlreadyPosted = false;
		...
		$(document).ready(function(){
			...
			if (!(browserInfo.name.toLowerCase().indexOf("chrome") > -1 && parseInt(browserInfo.version) >= 46) 
					&& !(browserInfo.name.toLowerCase().indexOf("safari") > -1 && parseInt(browserInfo.version) >= 9)) {
				var contentDiv = document.getElementById("content");							
				
				contentDiv.innerHTML = 
					"<div><div><center><b>Oh no! Unfortunately your browser is not supported!</b><br><br>Please use <b>Chrome at version 46 or higher.</b> If you are on Mac OSX, you can also use <b>Safari at version 9 or higher</b>.<br><br>If you want to contact us, please send a message through Amazon Mechanical Turk or to <b>sdcl.crowddesign@gmail.com</b>.<br><br>Thank you very much for your time and sorry for the inconvenience.";
			}
		});
	</script>
